Sagawa Tracking API - Java
================================
Use Java to track Sagawa shipments with Sagawa Tracking API.

Features
--------
- Real-time Sagawa tracking.
- Batch Sagawa tracking.
- Other features to manage your Sagawa tracking.
...
Then, start to track your Sagawa shipments.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.sagawa;
    ...
    public class CreateSagawaTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setCourierCode("sagawa");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateSagawaTrackingsExample {
...
Get status of the shipment:
    ...
    public class GetSagawaTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                trackingParams.setCourierCode("sagawa");
...
Update a tracking by ID:
    ...
    public class UpdateSagawaTrackingExample {
